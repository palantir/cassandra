...
# G1GC unloads classes during a full gc. For verbose logging enable the below:
# JVM_OPTS="$JVM_OPTS -XX:+TraceClassUnloading"
...
# Java 15 is required to run this version of Cassandra.
