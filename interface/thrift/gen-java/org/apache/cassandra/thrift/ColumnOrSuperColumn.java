...
public class ColumnOrSuperColumn implements org.apache.thrift.TBase<ColumnOrSuperColumn, ColumnOrSuperColumn._Fields>, java.io.Serializable, Cloneable, Comparable<ColumnOrSuperColumn> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ColumnOrSuperColumnStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ColumnOrSuperColumnTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable Column column; // optional
  public @org.apache.thrift.annotation.Nullable SuperColumn super_column; // optional
  public @org.apache.thrift.annotation.Nullable CounterColumn counter_column; // optional
  public @org.apache.thrift.annotation.Nullable CounterSuperColumn counter_super_column; // optional
  ...
  private static final _Fields optionals[] = {_Fields.COLUMN,_Fields.SUPER_COLUMN,_Fields.COUNTER_COLUMN,_Fields.COUNTER_SUPER_COLUMN};
  ...
  public ColumnOrSuperColumn setColumn(@org.apache.thrift.annotation.Nullable Column column) {
    this.column = column;
    return this;
  }
  ...
  public ColumnOrSuperColumn setSuper_column(@org.apache.thrift.annotation.Nullable SuperColumn super_column) {
  ...
  public ColumnOrSuperColumn setCounter_column(@org.apache.thrift.annotation.Nullable CounterColumn counter_column) {
  ...
  public ColumnOrSuperColumn setCounter_super_column(@org.apache.thrift.annotation.Nullable CounterSuperColumn counter_super_column) {
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCounter_column()) ? 131071 : 524287);
    if (isSetCounter_column())
      hashCode = hashCode * 8191 + counter_column.hashCode();

    hashCode = hashCode * 8191 + ((isSetCounter_super_column()) ? 131071 : 524287);
    if (isSetCounter_super_column())
      hashCode = hashCode * 8191 + counter_super_column.hashCode();
  ...
  public int compareTo(ColumnOrSuperColumn other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCounter_column(), other.isSetCounter_column());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCounter_column()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCounter_super_column(), other.isSetCounter_super_column());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCounter_super_column()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ColumnOrSuperColumn(");
    boolean first = true;
  ...
  private static class ColumnOrSuperColumnStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class ColumnOrSuperColumnStandardScheme extends org.apache.thrift.scheme.StandardScheme<ColumnOrSuperColumn> {
  ...
  private static class ColumnOrSuperColumnTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class ColumnOrSuperColumnTupleScheme extends org.apache.thrift.scheme.TupleScheme<ColumnOrSuperColumn> {
