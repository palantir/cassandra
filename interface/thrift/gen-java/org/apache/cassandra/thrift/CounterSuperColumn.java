...
public class CounterSuperColumn implements org.apache.thrift.TBase<CounterSuperColumn, CounterSuperColumn._Fields>, java.io.Serializable, Cloneable, Comparable<CounterSuperColumn> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CounterSuperColumnStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CounterSuperColumnTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer name; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<CounterColumn> columns; // required
  ...
  public CounterSuperColumn(
    ...
    java.util.List<CounterColumn> columns)
  {
    this();
  ...
  public CounterSuperColumn(CounterSuperColumn other) {
    ...
    if (other.isSetColumns()) {
      java.util.List<CounterColumn> __this__columns = new java.util.ArrayList<CounterColumn>(other.columns.size());
  ...
  public CounterSuperColumn setName(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer name) {
    this.name = org.apache.thrift.TBaseHelper.copyBinary(name);
    return this;
  }
  ...
  public void addToColumns(CounterColumn elem) {
    if (this.columns == null) {
      this.columns = new java.util.ArrayList<CounterColumn>();
    }
    this.columns.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<CounterColumn> getColumns() {
    return this.columns;
  }

  public CounterSuperColumn setColumns(@org.apache.thrift.annotation.Nullable java.util.List<CounterColumn> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COLUMNS:
      if (value == null) {
        ...
        setColumns((java.util.List<CounterColumn>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CounterSuperColumn(");
    boolean first = true;
  ...
  private static class CounterSuperColumnStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class CounterSuperColumnStandardScheme extends org.apache.thrift.scheme.StandardScheme<CounterSuperColumn> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<CounterColumn>(_list8.size);
                @org.apache.thrift.annotation.Nullable CounterColumn _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new CounterColumn();
                  _elem9.read(iprot);
  ...
  private static class CounterSuperColumnTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class CounterSuperColumnTupleScheme extends org.apache.thrift.scheme.TupleScheme<CounterSuperColumn> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CounterSuperColumn struct) throws org.apache.thrift.TException {
      ...
      struct.setNameIsSet(true);
      {
        ...
        struct.columns = new java.util.ArrayList<CounterColumn>(_list13.size);
        @org.apache.thrift.annotation.Nullable CounterColumn _elem14;
        for (int _i15 = 0; _i15 < _list13.size; ++_i15)
        {
          _elem14 = new CounterColumn();
          _elem14.read(iprot);
