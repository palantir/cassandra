...
public class KeyRange implements org.apache.thrift.TBase<KeyRange, KeyRange._Fields>, java.io.Serializable, Cloneable, Comparable<KeyRange> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new KeyRangeStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new KeyRangeTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String start_token; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String end_token; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<IndexExpression> row_filter; // optional
  ...
  private static final _Fields optionals[] = {_Fields.START_KEY,_Fields.END_KEY,_Fields.START_TOKEN,_Fields.END_TOKEN,_Fields.ROW_FILTER};
  ...
  public KeyRange(KeyRange other) {
    ...
    if (other.isSetRow_filter()) {
      java.util.List<IndexExpression> __this__row_filter = new java.util.ArrayList<IndexExpression>(other.row_filter.size());
  ...
  public KeyRange setStart_key(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer start_key) {
  ...
  public KeyRange setEnd_key(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer end_key) {
  ...
  public KeyRange setStart_token(@org.apache.thrift.annotation.Nullable java.lang.String start_token) {
  ...
  public KeyRange setEnd_token(@org.apache.thrift.annotation.Nullable java.lang.String end_token) {
  ...
  public void addToRow_filter(IndexExpression elem) {
    if (this.row_filter == null) {
      this.row_filter = new java.util.ArrayList<IndexExpression>();
    }
  ...
  public KeyRange setRow_filter(@org.apache.thrift.annotation.Nullable java.util.List<IndexExpression> row_filter) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ROW_FILTER:
      if (value == null) {
        ...
        setRow_filter((java.util.List<IndexExpression>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRow_filter()) ? 131071 : 524287);
    if (isSetRow_filter())
      hashCode = hashCode * 8191 + row_filter.hashCode();
  ...
  public int compareTo(KeyRange other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRow_filter(), other.isSetRow_filter());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRow_filter()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("KeyRange(");
    boolean first = true;
  ...
  private static class KeyRangeStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class KeyRangeStandardScheme extends org.apache.thrift.scheme.StandardScheme<KeyRange> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.row_filter = new java.util.ArrayList<IndexExpression>(_list32.size);
                @org.apache.thrift.annotation.Nullable IndexExpression _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new IndexExpression();
                  _elem33.read(iprot);
                  struct.row_filter.add(_elem33);
                }
                iprot.readListEnd();
              }
  ...
  private static class KeyRangeTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class KeyRangeTupleScheme extends org.apache.thrift.scheme.TupleScheme<KeyRange> {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.row_filter = new java.util.ArrayList<IndexExpression>(_list37.size);
          @org.apache.thrift.annotation.Nullable IndexExpression _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new IndexExpression();
            _elem38.read(iprot);
            struct.row_filter.add(_elem38);
          }
        }
        struct.setRow_filterIsSet(true);
      }
