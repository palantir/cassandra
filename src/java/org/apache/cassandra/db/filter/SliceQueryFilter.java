...
public class SliceQueryFilter implements IDiskAtomFilter
{
    ...
    private RangeTombstoneCounter rangeTombstoneCounter = RangeTombstoneCounter.EMPTY;
    ...
    public void collectReducedColumns(ColumnFamily container, Iterator<Cell> reducedColumns, DecoratedKey key, int gcBefore, long now)
    {
        ...
        rangeTombstoneCounter = RangeTombstoneCounter.create(gcBefore, container.deletionInfo());
    ...
    {
        return (columnCounter == null ? 0 : columnCounter.tombstones()) + rangeTombstoneCounter.getRangeTombstones();
    }
    ...
    public int lastReadDroppableTombstones()
    {
        return (reducedCells == null ? 0 : reducedCells.droppableTombstones())
               + rangeTombstoneCounter.getDroppableRangeTombstones();
    }
    ...
    {
        return (reducedCells == null ? 0 : reducedCells.tombstones()) + rangeTombstoneCounter.getRangeTombstones();
    }
