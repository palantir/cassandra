...
public class CQLWeighableMarshallableQuery extends AbstractCQLWeighableMarshallable
{
    private String query;

    public static final String TYPE = "single";

    public CQLWeighableMarshallableQuery() {
        super();
    }
    ...
    public void readMarshallable(WireIn wire) throws IORuntimeException
    {
        ...
        this.query = wire.read("query").text();
    }
}
