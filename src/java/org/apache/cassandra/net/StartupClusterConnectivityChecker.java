...
public class StartupClusterConnectivityChecker
{
     ...
     * else false.
     */
    public boolean execute(Set<InetAddress> peers)
    {
        ...
        peers.remove(FBUtilities.getBroadcastAddress());
        ...
        Set<InetAddress> alivePeers = Sets.newSetFromMap(new ConcurrentHashMap<>());
     ...
     */
    private void sendPingMessages(Set<InetAddress> peers, CountDownLatch latch, AckMap acks)
    {
    ...
    private static final class AliveListener implements IEndpointStateChangeSubscriber
    {
        ...
        AliveListener(Set<InetAddress> livePeers, CountDownLatch latch, AckMap acks)
        {
            this.latch = latch;
