...
public class StorageProxy implements StorageProxyMBean
{
    ...
    throws UnavailableException, IsBootstrappingException, RequestFailureException, RequestTimeoutException, InvalidRequestException
    {
        ...
        try
        {
            ...
            Supplier<Pair<ColumnFamily, RowIterator>> updateProposer = () ->
            {
                ...
                if (!request.appliesTo(current))
                {
                    ...
                    return Pair.create(current, current.iterator());
                }
    ...
    private static RowIterator doPaxos(CFMetaData metadata,
                                       ...
                                       Supplier<Pair<ColumnFamily, RowIterator>> createUpdateProposal)
    throws UnavailableException, IsBootstrappingException, RequestFailureException, RequestTimeoutException, InvalidRequestException
    {
        int contentions = 0;
        try
        {
            ...
            while (System.nanoTime() - queryStartNanoTime < timeout)
            {
                ...
                Pair<List<InetAddress>, Integer> p = getPaxosParticipants(metadata.ksName, key, consistencyForPaxos);
                ...
                Pair<ColumnFamily, RowIterator> proposalPair = createUpdateProposal.get();
                // See method javadoc: null here is code for "stop here and return null".
                if (proposalPair == null)
                    return null;

                Commit proposal = Commit.newProposal(key, ballot, proposalPair.left);
        ...
        try
        {
            ...
            try
            {
                ...
                Supplier<Pair<ColumnFamily, RowIterator>> updateProposer =
                    ...
                    ? () -> null
                    : () -> Pair.create(command.cfName, null);
            ...
            result = fetchRows(commands, consistencyForReplayCommitOrFetch);
        }
        catch (UnavailableException e)
        {
            readMetrics.unavailables.mark();
