...
public class NativeProtocolTest extends TestBaseImpl
{
    ...
    public void withClientRequests() throws Throwable
    {
                                              ...
                                              .start()))
        {
            ...
            try (com.datastax.driver.core.Cluster cluster = Dropwizard4Cluster.builder().addContactPoint("127.0.0.1").build();
    ...
    public void withCounters() throws Throwable
    {
        try (ICluster ignored = init(builder().withNodes(3)
                                              ...
                                              .start()))
        {
            final com.datastax.driver.core.Cluster cluster = Dropwizard4Cluster.builder().addContactPoint("127.0.0.1").build();
            Session session = cluster.connect();
