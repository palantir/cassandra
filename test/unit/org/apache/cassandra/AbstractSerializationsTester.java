...
{
    protected static final String CUR_VER = System.getProperty("cassandra.version", "2.2");
    ...
    {{
        ...
        put("2.2", MessagingService.VERSION_22_18);
    }};

    protected static final boolean EXECUTE_WRITES = true;
