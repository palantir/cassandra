...
public class StartupClusterConnectivityCheckerTest
{
    ...
    public void testConnectivity_SimpleHappyPath() throws UnknownHostException
    {
        ...
        int count = 10;
        Set<InetAddress> peers = createNodes(count);
     ...
     */
    private class UpdatablePredicate implements Predicate<InetAddress>
    {
        int index;
        int threshold;
    ...
    private static Set<InetAddress> createNodes(int count) throws UnknownHostException
    {
        ...
        {
            node = InetAddress.getByAddress(InetAddresses.increment(node).getAddress());
            nodes.add(node);
        }
        return nodes;
    }
