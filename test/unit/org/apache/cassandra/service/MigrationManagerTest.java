...
public class MigrationManagerTest
{
    ...
    public static void setup() throws UnknownHostException
    {
        ...
        MessagingService.instance().setVersion(HOST_1, MessagingService.VERSION_22_18);
        MessagingService.instance().setVersion(HOST_2, MessagingService.VERSION_22_18);
        MessagingService.instance().setVersion(HOST_3, MessagingService.VERSION_22_18);
        MessagingService.instance().setVersion(HOST_4, MessagingService.VERSION_22_18);
    }
